<script lang="ts">
    ...
    let error = data?.error as PageData["error"];
    let product = data?.product as PageData["product"];
    let relatedProducts = (data?.relatedProducts || []) as NonNullable<
        PageData["relatedProducts"]
    >;
    let images = (product?.preview ?? []) as string[];
                    ...
                    <ol class="flex flex-wrap items-center gap-2">
                        ...
                        <li>
                            <a
                                data-sveltekit-preload-data
                                href="/products"
                                class="text-primary hover:underline">Products</a
                            >
                        </li>
                        <li class="text-gray-400">/</li>
